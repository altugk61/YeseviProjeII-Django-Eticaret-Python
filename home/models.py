...
class Setting(models.Model):
    ...
    email = models.CharField(blank=True,
                             max_length=50)
    smtpserver = models.CharField(blank=True,
                                  max_length=20)
    smtpemail = models.CharField(blank=True,
                                 max_length=20)
    smtppassword = models.CharField(blank=True,
                                    max_length=10)
    smtpport = models.CharField(blank=True,
                                max_length=5)
...
class ContactForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'message': Textarea(attrs={'class': 'form-control', 'placeholder': 'Your Message Here', 'rows': '5'}),
        }
